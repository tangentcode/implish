...
* TEST char-num-conversions : chr, ord, hex, oct conversions
#+begin_src imp
> echo chr 65
A
> echo chr 65 66 67
...
* TEST imparse-postfix-left-noun : imparse: postfix verbs with noun on the left
#+begin_src imp
...
"second"
#+end_src
* TEST imparse-prefix-precedence : imparse: prefix verbs bind tighter than infix
#+begin_src imp
> imparse '[1 + 2 * ! 10]
*[+[1 ; 2] ; ![10]]
#+end_src
...
* TEST paren-infix-prefix : parentheses with prefix inside
#+begin_src imp
> (1 + 2 * ! 10)
0 3 6 9 12 15 18 21 24 27
#+end_src

* TEST imparse-infix-monadic-right : infix with monadic verb on the right
#+begin_src imp
> imparse '[1 + 2 * ! 10]
*[+[1 ; 2] ; ![10]]
#+end_src
